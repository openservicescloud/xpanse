...
public class DeployVariableValidator {
            ...
            for (DeployVariable deployVariable : deployVariables) {
                ...
                if (Objects.equals(kind, DeployVariableKind.VARIABLE)
                    ...
                    DeployVariableType type =
                            DeployVariableType.valueOf(
                                    StringUtils.upperCase(deployVariable.getType()));
     ...
     * @return isValid
     */
    public boolean checkVariableValidation(List<DeployVariable> deployVariables,
        ...
        if (!CollectionUtils.isEmpty(deployVariables) && Objects.nonNull(deployProperty)) {
            ...
            log.error("userPutKeys:{}", userPutKeys);
            ...
            if (!ignoredKeys.isEmpty()) {
                throw new IllegalArgumentException(String.format("Required context of service not"
