...
import org.eclipse.xpanse.modules.engine.enums.BuilderState;
...
public abstract class AtomBuilder {
     ...
     */
    public boolean rollback(BuilderContext context) {
        ...
        for (AtomBuilder subBuilder : subBuilders) {
            if (!subBuilder.rollback(context)) {
                setState(BuilderState.FAILED);
            }
        }
     ...
     */
    public abstract boolean create(BuilderContext context);
     ...
     * @return The creating result, true or false.
     */
    public abstract boolean destroy(BuilderContext context);
}
